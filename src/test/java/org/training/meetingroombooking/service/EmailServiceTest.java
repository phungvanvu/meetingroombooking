...
class EmailServiceTest {
    ...
    void setUp() {
        ...
        user = new User();
        user.setEmail("npthao808@gmail.com");
        user.setFullName("Test User");
        user.setUserId(1L);

        roomBookingDTO = new RoomBookingDTO();
        roomBookingDTO.setRoomId(1L);
        roomBookingDTO.setRoomName("Room A");  // ✅ Bổ sung
        roomBookingDTO.setUserEmail("npthao808@gmail.com");  // ✅ Bổ sung
        roomBookingDTO.setBookedById(1L);
        roomBookingDTO.setUserName("Test User");  // ✅ Bổ sung
    ...
    void testSendRoomBookingConfirmationEmail() throws MessagingException, IOException {
        ...
        Address[] addresses = new Address[] { new InternetAddress("npthao808@gmail.com") };
        ...
        // Set the content of the MimeMessage
        when(mimeMessage.getContent()).thenReturn("You have successfully booked a meeting room!");
        ...
        assertEquals("npthao808@gmail.com", capturedMessage.getRecipients(MimeMessage.RecipientType.TO)[0].toString());
