...
class GroupServiceTest {
    ...
    void testUpdateGroup() {
        ...
        // Giả lập phương thức save để trả về đối tượng đã cập nhật
        when(groupRepository.save(groupEntity)).thenReturn(updatedGroupEntity);

        // Giả lập phương thức toDTO để trả về DTO đã cập nhật
