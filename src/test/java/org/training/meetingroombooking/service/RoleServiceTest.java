...
class RoleServiceTest {
    ...
    void ***REMOVED***CreateRole_Success() {
        ...
        when(permissionRepository.findAllById(Set.of("READ", "WRITE"))).thenReturn(List.of(permissionRead, permissionWrite));
    ...
    void ***REMOVED***UpdateRole_Success() {
        ...
        Role updatedRole = new Role("ADMIN", "Updated Admin role", Set.of(permissionRead, permissionWrite));
