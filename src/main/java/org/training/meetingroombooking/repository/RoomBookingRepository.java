...
public interface RoomBookingRepository extends JpaRepository<RoomBooking, Long>,
  ...
  List<RoomBooking> findByBookedBy_UserNameAndStatusAndStartTimeAfter(String userName,
      BookingStatus status, LocalDateTime time);

  List<RoomBooking> findByRoom_roomIdAndStatusAndStartTimeAfter(Long roomId, BookingStatus status,
      LocalDateTime time);
