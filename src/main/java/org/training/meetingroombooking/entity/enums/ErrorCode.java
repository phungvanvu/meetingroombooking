...
public enum ErrorCode {
  ...
  PARTIAL_ROOM_DELETE_FAILED(
      HttpStatus.CONFLICT, "Some rooms could not be deleted due to active bookings."),
  PARTIAL_USER_DELETE_FAILED(
      HttpStatus.CONFLICT, "Some users could not be deleted due to active bookings."),
  ...
  CANNOT_DELETE_USER_IN_USE(
      HttpStatus.CONFLICT, "Cannot delete user: User is associated with existing bookings."),
  CANNOT_DELETE_ROOM_IN_USE(
      HttpStatus.CONFLICT, "Cannot delete room: Room is associated with existing bookings."),
  CANNOT_DELETE_GROUP_IN_USE(
      HttpStatus.CONFLICT, "Cannot delete group: Group is associated with existing users."),
  CANNOT_DELETE_POSITION_IN_USE(
      HttpStatus.CONFLICT, "Cannot delete position: Position is associated with existing users."),
  CANNOT_DELETE_EQUIPMENT_IN_USE(
      HttpStatus.CONFLICT, "Cannot delete equipment: Equipment is associated with existing rooms."),
