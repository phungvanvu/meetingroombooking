...
public class UserRequest {
  ...
  @Pattern(
      regexp = "^[A-Za-z0-9]+$",
      message = "Username must contain only non-accented letters and numbers")
  ...
  @Pattern(
      ...
      message =
          "Invalid email format. Please provide a valid email address with proper domain (e.g., user@example.com).")
