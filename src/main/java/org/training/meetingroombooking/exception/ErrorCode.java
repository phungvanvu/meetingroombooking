...
public enum ErrorCode {
    ...
    INVALID_EMAIL_DOMAIN("Invalid email domain. Only .vn, .edu, and .com are allowed."),
    PASSWORD_NOT_PROVIDED( "Password must be provided."),
    DEPARTMENT_CANNOT_BE_EMPTY("Username cannot be empty" ),
    EMAIL_CANNOT_BE_EMPTY("Email cannot be empty"),
    FULLNAME_CANNOT_BE_EMPTY("Full name cannot be empty" ),
    USERNAME_CANNOT_BE_EMPTY("Username cannot be empty"),
    PASSWORD_CANNOT_BE_EMPTY("Password must be provided." ),
    ROLES_CANNOT_BE_EMPTY( "role must be provided.");
